...
HD_PWD='E:/Users/Kyle/Documents/sr_proj_test/image_uart_new/image_uart_new.runs/vga_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_clk.tcl
