...
#
# Generated by export_simulation on Fri Mar 12 13:39:34 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './uartloader_fifo.sh' script.

./uartloader_fifo.sh -reset_run
...
./uartloader_fifo.sh -noclean_files

For more information on the script, please type './uartloader_fifo.sh -help'.
