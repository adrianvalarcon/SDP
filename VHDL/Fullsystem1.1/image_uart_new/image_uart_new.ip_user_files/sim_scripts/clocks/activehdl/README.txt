...
#
# Generated by export_simulation on Fri Mar 12 13:39:39 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './vga_clk.sh' script.

./vga_clk.sh -reset_run
...
./vga_clk.sh -noclean_files

For more information on the script, please type './vga_clk.sh -help'.
