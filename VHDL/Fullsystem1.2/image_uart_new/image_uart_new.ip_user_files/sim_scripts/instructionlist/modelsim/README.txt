...
#
# Generated by export_simulation on Fri Mar 12 13:39:31 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './instructionlist.sh' script.

./instructionlist.sh -reset_run
...
./instructionlist.sh -noclean_files

For more information on the script, please type './instructionlist.sh -help'.
